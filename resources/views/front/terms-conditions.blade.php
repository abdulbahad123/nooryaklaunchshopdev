          ...
          <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 16px; background: #ffffff; border: 1px solid #e2e8f0;">
            <div class="card-body">
              ...
              <div class="content-text" style="color: #475569; line-height: 1.8; font-size: 15px;">
                <p>Welcome to EcomBuilder.in. These Terms & Conditions outline the rules and regulations for the use of Ecom Builder's Website and services.</p>
                
                <h4 class="mt-4 mb-2" style="font-weight: 700; color: #1e293b;">1. Terms</h4>
                <p>By accessing this website, we assume you accept these Terms & Conditions in full. Do not continue to use EcomBuilder.in if you do not agree to take all of the terms stated on this page.</p>
                
                <h4 class="mt-4 mb-2" style="font-weight: 700; color: #1e293b;">2. Subscriptions and Billing</h4>
                <p>Subscriptions on EcomBuilder.in are billed on a recurring monthly or yearly basis, or as a lifetime fee, depending on the plan selected during checkout. It is the store owner's responsibility to maintain active payment configurations to prevent suspension of their online storefront.</p>
                ...
                <p>EcomBuilder.in is provided "as is," without warranties of any kind. Under no circumstances shall EcomBuilder.in be held liable for store downtime, order processing errors, payment gateway failures, loss of profits, or data leaks resulting from third-party hosting issues.</p>
