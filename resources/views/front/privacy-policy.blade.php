          ...
          <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 16px; background: #ffffff; border: 1px solid #e2e8f0;">
            <div class="card-body">
              ...
              <div class="content-text" style="color: #475569; line-height: 1.8; font-size: 15px;">
                <p>Welcome to EcomBuilder.in. Your privacy is of paramount importance to us. This Privacy Policy document details the types of personal information that is collected and recorded by EcomBuilder.in and how we use it.</p>
                ...
                <p>EcomBuilder.in uses standard tracking technologies and cookies to store session states, save user dashboard settings, and track referral and traffic sources to optimize service delivery. You can disable cookies in your browser settings, though some features may fail to function correctly.</p>
                
                <h4 class="mt-4 mb-2" style="font-weight: 700; color: #1e293b;">4. Third-Party Services</h4>
                <p>We integrate secure third-party payment gateways (like Razorpay, Stripe, Paytm, and PayPal) to process transaction fees. EcomBuilder.in does not store card numbers or banking passwords on our servers. All payment transactions comply with secure industry protocols.</p>
                
                <h4 class="mt-4 mb-2" style="font-weight: 700; color: #1e293b;">5. Contact Us</h4>
                <p>If you have any additional questions or require more information about our Privacy Policy, please do not hesitate to contact us at support@ecombuilder.in.</p>
              </div>
            </div>
          </div>
        </div>
