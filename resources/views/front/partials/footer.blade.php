          ...
          <div class="footer-widget" data-aos="fade-up" data-aos-delay="200">
            ...
            <ul class="footer-links">
              @foreach ($ulinks as $ulink)
                ...
                @endif
              @endforeach
              <li><a href="{{ \Illuminate\Support\Facades\Route::has('front.privacy-policy') ? route('front.privacy-policy') : url('/privacy-policy') }}">{{ __('Privacy Policy') }}</a></li>
              <li><a href="{{ \Illuminate\Support\Facades\Route::has('front.terms-conditions') ? route('front.terms-conditions') : url('/terms-conditions') }}">{{ __('Terms & Conditions') }}</a></li>
              <li><a href="{{ \Illuminate\Support\Facades\Route::has('front.refund-policy') ? route('front.refund-policy') : url('/refund-policy') }}">{{ __('Cancellation & Refund Policy') }}</a></li>
              <li><a href="{{ \Illuminate\Support\Facades\Route::has('front.shipping-policy') ? route('front.shipping-policy') : url('/shipping-policy') }}">{{ __('Shipping & Delivery Policy') }}</a></li>
            </ul>
          </div>
        </div>
