      ...
      <div class="mobile-menu-top">
        ...
        <div class="logo">
          ...
          <a href="{{ route('front.user.detail.view', getParam()) }}" class="logo">
            <img class="lazyload" src="{{ asset('assets/front/images/placeholder.png') }}" data-src="{{ !empty(@$userBs->logo) ? asset('assets/front/img/user/' . @$userBs->logo) : asset('assets/front/img/logo.png') }}" alt="logo">
          </a>
        </div>
