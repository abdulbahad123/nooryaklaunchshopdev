...
<ul class="nav nav-tabs mb-4 border-bottom" id="settingsTabs">
  ...
  <li class="nav-item"><button class="nav-link fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-contact"><i class="fa-solid fa-envelope me-1"></i> Contact</button></li>
</ul>
...
<div class="tab-content">
  ...
  <div class="tab-pane fade" id="tab-contact">
    <div class="card p-4">
      <h5 class="fw-bold mb-3"><i class="fa-solid fa-envelope me-2 text-primary"></i>Contact & Footer Info</h5>
      <div class="row g-3">
        <div class="col-md-6">
