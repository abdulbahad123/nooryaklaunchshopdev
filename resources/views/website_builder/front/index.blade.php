  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .pricing-card-wrap:hover {
      ...
      box-shadow: 0 20px 50px rgba(91, 75, 245, 0.12);
      border-color: #CBD5E1;
    }
    .pricing-card-wrap.popular {
      border: 2px solid #5B4BF5;
      background: linear-gradient(180deg, #FFFFFF 0%, #F5F3FF 100%);
      box-shadow: 0 20px 50px rgba(91, 75, 245, 0.18);
    }
    .pricing-popular-badge {
      ...
      left: 50%;
      transform: translateX(-50%);
      background: linear-gradient(135deg, #5B4BF5 0%, #4338CA 100%);
      color: #ffffff;
      font-size: 12px;
      font-weight: 800;
      padding: 6px 20px;
    ...
    .pricing-tier-name { font-size: 22px; font-weight: 900; color: #0F172A; margin-bottom: 6px; }
    .pricing-tier-sub { font-size: 13.5px; color: #64748B; margin-bottom: 24px; font-weight: 500; }
    .pricing-price { font-size: 48px; font-weight: 900; color: #0F172A; line-height: 1; letter-spacing: -1px; }
    .pricing-price sup { font-size: 24px; vertical-align: super; font-weight: 800; color: #5B4BF5; }
    .pricing-period { font-size: 14px; color: #64748B; font-weight: 600; margin-left: 4px; }
    .pricing-billing { font-size: 12px; color: #94A3B8; font-weight: 700; margin-top: 6px; margin-bottom: 24px; text-transform: uppercase; letter-spacing: 0.5px; }
    .pricing-divider { border: none; border-top: 1px solid #E2E8F0; margin: 24px 0; }
    ...
    .pricing-features li i { color: #10B981; font-size: 16px; flex-shrink: 0; }
    .btn-pricing {
      display: block;
      text-align: center;
      padding: 14px 20px;
    ...
    .btn-pricing.filled {
      ...
      color: #ffffff;
      border: none;
      box-shadow: 0 8px 24px rgba(91, 75, 245, 0.3);
    }
    .btn-pricing.filled:hover {
      background: linear-gradient(135deg, #4338CA 0%, #312E81 100%);
      transform: translateY(-2px);
      box-shadow: 0 12px 32px rgba(91, 75, 245, 0.4);
      color: #ffffff;
    }
    .btn-pricing.outline {
      background: #ffffff;
    ...
    <div class="templates-row">
      ...
      <div class="template-card">
        ...
        <div class="template-body">
          ...
          <div class="template-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
            <a href="{{ $demoUrl }}" target="_blank" class="btn-view-demo text-center" style="grid-column: span 2; font-size: 13px; padding: 8px 10px; border-radius: 8px; border: 1.5px solid var(--border); color: var(--text-dark); text-decoration: none; font-weight: 600; display: block; width: 100%;">View Demo</a>
      ...
      <div class="template-card">
        ...
        <div class="template-body">
          ...
          <div class="template-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
            <a href="{{ route('website-builder.templates.digital_agency') }}" target="_blank" class="btn-view-demo text-center" style="grid-column: span 2; font-size: 13px; padding: 8px 10px; border-radius: 8px; border: 1.5px solid var(--border); color: var(--text-dark); text-decoration: none; font-weight: 600; display: block; width: 100%;">View Demo</a>
      ...
      <div class="template-card">
        ...
        <div class="template-body">
          ...
          <div class="template-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
            <a href="{{ route('website-builder.templates.interior') }}" target="_blank" class="btn-view-demo text-center" style="grid-column: span 2; font-size: 13px; padding: 8px 10px; border-radius: 8px; border: 1.5px solid var(--border); color: var(--text-dark); text-decoration: none; font-weight: 600; display: block; width: 100%;">View Demo</a>
      ...
      <div class="template-card">
        ...
        <div class="template-body">
          ...
          <div class="template-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
            <a href="{{ route('website-builder.templates.texigo') }}" target="_blank" class="btn-view-demo text-center" style="grid-column: span 2; font-size: 13px; padding: 8px 10px; border-radius: 8px; border: 1.5px solid var(--border); color: var(--text-dark); text-decoration: none; font-weight: 600; display: block; width: 100%;">View Demo</a>
      ...
      <div class="template-card">
        ...
        <div class="template-body">
          ...
          <div class="template-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
            <a href="{{ route('website-builder.templates.construction') }}" target="_blank" class="btn-view-demo text-center" style="grid-column: span 2; font-size: 13px; padding: 8px 10px; border-radius: 8px; border: 1.5px solid var(--border); color: var(--text-dark); text-decoration: none; font-weight: 600; display: block; width: 100%;">View Demo</a>
      ...
      <div class="template-card">
        ...
        <div class="template-body">
          ...
          <div class="template-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
            <a href="{{ route('website-builder.templates.evently') }}" target="_blank" class="btn-view-demo text-center" style="grid-column: span 2; font-size: 13px; padding: 8px 10px; border-radius: 8px; border: 1.5px solid var(--border); color: var(--text-dark); text-decoration: none; font-weight: 600; display: block; width: 100%;">View Demo</a>
