...
<!-- ===== EVENT CATEGORIES ===== -->
<section class="ev-categories-section">
  <div class="ev-container">
    ...
    @php
      $eventCategories = [
        ['title' => 'Corporate Events',        'desc' => 'Conferences, seminars, product launches and more.', 'image' => asset('assets/website_builder/Templates/Evently/event_business_summit.png')],
        ['title' => 'Weddings & Private Events','desc' => 'Make your special day truly unforgettable.',       'image' => asset('assets/website_builder/Templates/Evently/event_grand_wedding.png')],
        ['title' => 'Social Gatherings',       'desc' => 'Birthdays, anniversaries and celebrations.',        'image' => asset('assets/website_builder/Templates/Evently/event_music_fest.png')],
        ['title' => 'Exhibitions & Trade Shows','desc' => 'Showcase your brand to the world.',               'image' => asset('assets/website_builder/Templates/Evently/event_corporate_gala.png')],
      ];
    @endphp
      ...
      @foreach($eventCategories as $cat)
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="ev-cat-card">
            <img src="{{ $cat['image'] }}" alt="{{ $cat['title'] }}" class="ev-cat-img"
            ...
            <div class="ev-cat-content">
              ...
              <div class="ev-cat-desc">{{ $cat['desc'] }}</div>
